    ...
    it('should find at least one URL', function (done) {
      ...
      .then(function(zipCodes) {
        ...
        urlsCasperScript.addObserver('data', function (message) {
          ...
          {
            return done(new SearchEngineException(se.getName(), message.data.message, message.data.trace));
          }
        ...
        urlsCasperScript.addObserver('exit', function (code) {
          ...
          if (code > 0)
          {
            return done(new SearchEngineException(se.getName(), `get-urls casper script exited with code = ${code}`));
          }
      ...
      .then(function(zipCodes) {
        ...
        urlsCasperScript.addObserver('exit', function(code) {
          ...
          offersCasperScript.addObserver('exit', function(code) {
            ...
            if (code > 0)
            {
              return done(new SearchEngineException(se.getName(), `get-offers casper script exited with code = ${code}`));
            }
